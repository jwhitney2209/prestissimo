...
const Cards = () => {
  return (
    <div className='w-full py-[1rem] md:py-[2rem] px-4 bg-black'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-4'>
        <div className='w-full bg-primary shadow-xl flex flex-col p-4 rounded-lg hover:scale-105 duration-300 text-white'>
          ...
          <button className='btn w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-white'>Get Info</button>
        </div>
